...
public enum ErrorCode {
    ...
    PLANNING_MODEL_UNAVAILABLE(HttpStatus.SERVICE_UNAVAILABLE, "规划模型尚未配置或不可用"),
    PLANNING_MODEL_TIMEOUT(HttpStatus.GATEWAY_TIMEOUT, "规划模型响应超时"),
    PLANNING_MODEL_RATE_LIMITED(HttpStatus.TOO_MANY_REQUESTS, "规划模型请求受限"),
    PLANNING_MODEL_INVALID_OUTPUT(HttpStatus.UNPROCESSABLE_CONTENT, "规划模型输出无效"),
